...
(function ($) {
  ...
  $.FroalaEditor.MODULES.keys = function (editor) {
    ...
    function _mapKeyUp (e) {
      ...
      if (e && (e.which == $.FroalaEditor.KEYCODE.ENTER || e.which == $.FroalaEditor.KEYCODE.BACKSPACE)) _positionCaret();
    ...
    */
    ...
    function _updateSticky (el) {
      ...
      var position = $el.data('sticky-position');
		  var scroll = $(editor.opts.scrollableContainer == 'body' ? editor.original_window : editor.opts.scrollableContainer).scrollTop();
      ...
      // Detect if is OK to fix at the top.
        ...
        // Current offset.
				offset_top = (editor.opts.scrollableContainer != 'body' ? scrollable_top : scroll) + el_top;
      ...
      // Detect if it is OK to fix at the bottom.
        ...
        offset_top = (editor.opts.scrollableContainer != 'body' ? scrollable_top : scroll) - el_bottom;

				// 1. Initial offset + height
        // 2. Don't exceed container top.
				return initial_offset + ( height || 0 ) > offset_top + viewport_height &&
        				offset_top + viewport_height >= parent_offset + height;
			}
    ...
    function _initSticky () {
      if (!_testSticky()) {
        ...
        // Default case. Do the updates on scroll.
          ...
          $(editor.opts.scrollableContainer == 'body' ? editor.original_window : editor.opts.scrollableContainer).on('scroll.sticky' + editor.id, bulkUpdate);
