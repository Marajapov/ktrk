  ...
  function appendTask(task, placeholder) {
	  if (task.type=='month'){
			...
			var card = $('<div style="font-size:11" id="event_month_'+task.id+'">'+task.startTimeString+' [<a href="#" onclick="delete_month_task_from_page('+task.id+','+task.column+');return false;">x</a>]<br>'+task.title+'</div>');
