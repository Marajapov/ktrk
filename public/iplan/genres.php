               ...
               <div class="content-i">
			      ...
			      <?php 
						...
						if (isset($_POST['act']) && $_POST['act']=='add') {
							 ...
							 $code = getpost('code');
							 $theme = getpost('theme');
							 $ins = array("name"=>$name, "code"=>$code, "theme"=>$theme);
							 $db->insert($table, $ins);
						}
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="element-wrapper">
                              <h6 class="element-header"><?php if ($act==1) echo "Добавить жанр"; else if ($act==2) echo "Редактировать"; ?></h6>
                                 ...
                                 <form action="" id='myForm' method="POST">
                                    <fieldset class="form-group">         
									   ...
									   <div class="row">
                                          <div class="col-sm-6">
                                             <div class="form-group">
                                                <label for="">Тематика жанров</label>
                                                <input class="form-control" type="text"  name="theme" <?php if ($act==2) echo 'value="'.$item["theme"].'"'; ?>>
                                             </div>
                                          </div>                                       
                                       </div>
                                    </fieldset>                              
                  ...
                  <div class="content-box">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="element-wrapper">
                              <h6 class="element-header">Жанры и тематика</h6>
                                    ...
                                    <table class="table table-lightborder">
                                       ...
                                       <tbody>
										...
										<tr>
											 ...
											 <td class="nowrap"><?php echo $p['theme'];?></td>
