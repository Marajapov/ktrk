$(function() {
    ...
    function hideWord($word) {
        var nextWord = takeNext($word),
        	wordId = $word.attr('data-project'),
        	project = $('#'+wordId),
        	nextId = nextWord.attr('data-project'),
        	nextProject = $('#'+nextId);
        ...
        if($word.parents('.us-headline').hasClass('type')) {
            ...
            setTimeout(function(){
                ...
                $project.removeClass('is-visible').addClass('is-hidden').children('i').removeClass('in').addClass('out');
            }, selectionDuration);
            ...
            $word.parents('.us-words-wrapper').animate({ width : '2px' }, revealDuration, function(){
                ...
                switchProject(project, nextProject);
                showWord(nextWord);
            });
    ...
    function switchProject($oldProject, $newProject) {
        $oldProject.removeClass('is-visible').addClass('is-hidden');
        $newProject.removeClass('is-hidden').addClass('is-visible');
    }
