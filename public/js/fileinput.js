...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        removeTitle: 'Файлды өчүрүү',
        uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Файлды жүктөө',
        indicatorNew: '<i class="glyphicon glyphicon-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="glyphicon glyphicon-ok-sign text-success"></i>',
        indicatorError: '<i class="glyphicon glyphicon-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="glyphicon glyphicon-hand-up text-muted"></i>',
        indicatorNewTitle: 'Жүктөлгөн жок',
        indicatorSuccessTitle: 'Жүктөлдү',
        indicatorErrorTitle: 'Жүктөө катасы',
        indicatorLoadingTitle: 'Жүкиөлүүдө ...'
    };
    tMain1 = '{preview}\n' +
...
//FileInput plugin definition
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'файл',
        filePlural: 'файл',
        browseLabel: 'Файлды жүктөө (Сүрөттөр & Видео)&hellip;',
        removeLabel: 'Өчүрүү',
        ...
        dropZoneTitle: 'Файлды көтөрүп келип койуңуз(Drag & Drop);'
    };
