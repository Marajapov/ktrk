...
//    'Homepage' => '',
    ...
    'TradeMarkRegulations' => 'Материалы, размещенные на сайте ktrk.kg предназначены только для персонального пользования. Использование материалов сайта, копирование, размещение, распространение возможно только при письменном согласовании с администрацией КТРК. При согласованном использовании материалов сайта обязательна ссылка на ресурс.',
