...
class HomeController extends Controller
{
    ...
    public function Home()
    {
        ...
        if($lc == 'kg'){
            $latestPosts = \Model\Post\ModelName::general($channel)->published()->where('number','=','99')->where('general','=','1')->languagekg()->take(6)->skip(0)->orderBy('id','desc')->orderBy('created_at','desc')->get();    
        }elseif($lc == 'ru'){
            $latestPosts = \Model\Post\ModelName::general($channel)->published()->where('number','=','99')->where('general','=','1')->languageru()->take(6)->skip(0)->orderBy('id','desc')->orderBy('created_at','desc')->get();    
        }
