              ...
              <div class="panel-body">
                ...
                <ul class="list-group first-level">
                        ...
                        <li class="list-group-item">
                          <div class="media">
                            ...
                            <div class="media-body">
                              <p>Отчет Корпорациянын «КТРК жөнүндө» мыйзамында камтылган тапшырмалар жана алардын аткарылыш деңгээли, КТРКнын 2016-жылга карай киреше жана чыгашаларынын жалпы маалыматтары менен каржылык - чарбалык ишмердүүлүгүнүн натыйжасы тууралуу маалыматты өзүнө камтыйт. Ошондой эле, отчетто кызматкерлердин кесиптик чеберчилигин жогорулатуу, окуу курстарын уюштуруу, административдик – чарбалык иштерди уюштуруу иштеринин жыйынтыгы келтирилген.</p>
                            </div>
                            <div class="media-right">
                              <a target="_blank" href="{{ asset('static/files/report/2016_kg.pdf') }}" class="btn btn-default"><i class="fa fa-file-pdf-o"></i></a>
                            </div>
                          </div>
                        </li>
                      </ul>
                  ...
                  @elseif($lc == 'ru')
                    ...
                    <li class="list-group-item">
                      Годовой отчет о деятельности  Общественной телерадиовещательной корпорации Кыргызской Республики за 2016 год
                      <ul class="list-group second-level">
                        <li class="list-group-item">
                          <div class="media">

                            <div class="media-body">
                              <p>Документ включает в себя информацию о задачах, поставленных перед Корпорацией в законе “об ОТРК” и степени их выполнения, о результатах финансово-хозяйственной деятельности КТРК с общими данными по доходам и расходам за 2016 год, о повышении квалификации сотрудников, организации учебных курсов, о проведенной административно-хозяйственной работе....</p>
                            </div>
                            <div class="media-right">
                              <a target="_blank" href="{{ asset('static/files/report/2016_ru.pdf') }}" class="btn btn-default"><i class="fa fa-file-pdf-o"></i></a>
                            </div>
                          </div>
                        </li>
                      </ul>
