...
@section('content')
    ...
    <div class="section light-section page-section">
                ...
                <div class="section-body">
                	<div class="media">
			              <div class="media-left clearfix">
			                <div class="media-object">
			                  <img src="{{ asset('images/history/chaban.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			                <div class="media-object-shadow">			                	
			                  <img src="{{ asset('images/history/chaban.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			              </div>
			              <div class="media-body">
			              	...
			              	<button class="page-more-btn btn-first">
			              		{{trans('site.More')}}
			              	</button>
			              	<div id="modal-first">
			              		@if($lc == 'kg')
                	...
                	<div class="media">
			              ...
			              <div class="media-right clearfix">
			                <div class="media-object">
			                  <img src="{{ asset('images/history/diktory.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			                <div class="media-object-shadow">			                	
			                  <img src="{{ asset('images/history/diktory.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			            ...
			            <div class="media">
			              <div class="media-left clearfix">
			                <div class="media-object">
			                  <img src="{{ asset('images/history/73.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			                <div class="media-object-shadow">			                	
			                  <img src="{{ asset('images/history/73.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			              ...
			              <div class="media-body">
                  			...
                  			@else
				                  ...
				                  <p>В 1958 году при Совете министров Кыргызской ССР организован Комитет по телевидению и радиовещанию и начинает свою работу Фрунзенская телестудия. Ее главой была назначена Рабия Менсеитова. Первым диктором Кыргызского телевидения была Сайнаке Жунушалиева, первым режиссером - Жанузак Молдобаев, первым редактором - Шаршеке Сматов, первым звукорежиссером - Светлана Варибада, первым оператором - Курманбек Огобаев.</p>
				                  <p>С 1961 по 1964 год Комитет по телерадиовещанию возглавляла Айымбубу Ботоканова.</p>
                  			@endif
			              	</article>
			              	@if($lc == 'kg')
			              		<button class="page-more-btn btn-second">
				              		{{trans('site.More')}}
				              	</button>
				              	<div id="modal-second">
                	...
                	<div class="media">
			              ...
			              <div class="media-right clearfix">
			                <div class="media-object">
			                  <img src="{{ asset('images/history/503.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			                <div class="media-object-shadow">			                	
			                  <img src="{{ asset('images/history/503.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			            ...
			            <div class="media">
			              <div class="media-left clearfix">
			                <div class="media-object">
			                  <img src="{{ asset('images/history/100.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			                <div class="media-object-shadow">			                	
			                  <img src="{{ asset('images/history/100.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			              ...
			              <div class="media-body">
                  			...
                  			@else
                  				<p>С 1985-1986 года комитет возглавляет Асанбек Стамов, с 1986-91 годы - Умтул Орозова.</p>
                  				<p>В 1991 году было организовано Государственное агентство по телевидению и радио Кыргызской Республики, во главе которого был назначен Сатыбалды Жээнбеков. В 1992 году руководителем был Туголбай Казаков, в 1993 году - Кадыркул Омуркулов, в 1994 - году Абдуламит Матисаков. В 1993 году агентство снова реорганизовано в комитет. В 1995 году Кыргызское телевидение пополнилось утренней студией «Замана».</p>
                  			@endif
			              	</article>
		              		<button class="page-more-btn btn-third">
			              		{{trans('site.More')}}
			              	</button>
			              	<div id="modal-third">
		              			@if($lc == 'kg')
	                      ...
	                      @else
	                      	<p>В 1996 году Государственный комитет по телевидению и радио был реорганизован в Государственную телерадиовещательную корпорацию Кыргызской Республики, руководителем которой был назначен Аманбек Карыпкулов. На кыргызском телевидении открылись информационный центр «Ала-Тоо», продюсерский центр «Нур», и «Ата-Журт».</p>
		                      <p>В 2001 году президентом корпорации был назначен Молдосейит Мамбетакунов, а в 2002 году - Токтош Айтикеева. В 2003 году Государственная телерадиокорпорация Кыргызской Республики получает статус Национальной телерадиовещательной корпорации Кыргызской Республики.</p>
		                      <p>В 2004 году президентом корпорации назначен Сыртбай Мусаев, в 2005 году - Султан Абдракманов, и в том же 2005 году – президентом был назначен Кыяс Молдокасымов.</p>
		              			@endif		              		
			              	</div>		              	
			              </div>
			            </div> 
                	<div class="media">
			              <div class="media-body">
			              	...
			              	<article>
				                ...
				                @else
                  				...
                  				<p>В 2010 году, после апрельской революции генеральным директором корпорации назначен Кубат Оторбаев, и по требованию общества, корпорация приобрела статус Общественной телерадиовещательной корпорации Кыргызской Республики. Приказ об Общественной телерадиовещательной корпорации был подписан Президентом Кыргызской Республики. В 2010 году избран Наблюдательный совет Общественной телерадиовещательной корпорации, в состав которого входит 15 членов. Председателем Наблюдательного совета избрана Эльвира Сариева. Был объявлен конкурс на замещение должности генерального директора корпорации, в декабре 2010 года по итогам которого, сроком на 5 лет, Генеральным директором КТРК был избран Кубат Оторбаев.</p>
			              ...
			              <div class="media-right clearfix">
			                <div class="media-object">
			                  <img src="{{ asset('images/history/skan493.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			                <div class="media-object-shadow">			                	
			                  <img src="{{ asset('images/history/skan493.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			            ...
			            <div class="media">
			              <div class="media-left clearfix">
			                <div class="media-object">
			                  <img src="{{ asset('images/history/58.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
			                <div class="media-object-shadow">			                	
			                  <img src="{{ asset('images/history/58.jpg')}}" alt="{{ trans('site.HistoryFull') }}">
			                </div>
...
<script>
    ...
    $('#modal-first').iziModal('open');
	});

	$("#modal-first").iziModal({
		title: "{{ trans('site.HistoryFull') }}",
		headerColor: "#ffffff",
    theme: 'light',  // light
    overlayClose: true,
    width: 640,
	...
	@if($lc == 'kg')
		// Second Modal
		$(document).on('click', '.btn-second', function (event) {
	    event.preventDefault();
	    $('#modal-second').iziModal('open');
		});

		$("#modal-second").iziModal({
			title: "{{ trans('site.HistoryFull') }}",
			headerColor: "#ffffff",
	    theme: 'light',  // light
	    overlayClose: true,
    ...
    event.preventDefault();
    $('#modal-third').iziModal('open');
	});

	$("#modal-third").iziModal({
		title: "{{ trans('site.HistoryFull') }}",
		headerColor: "#ffffff",
    theme: 'light',  // light
    overlayClose: true,
	...
	// Fourth Modal
	$(document).on('click', '.btn-fourth', function (event) {
    event.preventDefault();
    $('#modal-fourth').iziModal('open');
	});

	$("#modal-fourth").iziModal({
		title: "{{ trans('site.HistoryFull') }}",
		headerColor: "#ffffff",
    theme: 'light',  // light
    overlayClose: true,
