                            ...
                            <nav class="pagination-nav">
                                <ul class="pagination">
                                    <li class="pagination-auto">
                                        <a href="{{ route('front.media.all', ['page' => 1]) }}" class="@if($allVideos->currentPage() == 1) disabled @endif">{{ trans('site.Start') }}</a>
                                    </li>
                                    <li>
                                    ...
                                    @if($allVideos->currentPage() < 3)
                                        @for($i = 1; $i <= 5; $i++)
                                            <li>
                                                <a href="{{ route('front.media.all', ['page' => $i]) }}" class="@if($allVideos->currentPage() == $i) active @endif">
                                                    {{ $i }}
                                                </a>
                                            </li>
                                        @endfor
                                    ...
                                    <li class="pagination-auto">
                                        <a href="{{ route('front.media.all', ['page' => ceil($allVideos->total()/$perPage)]) }}" class="@if($allVideos->currentPage() == ceil($allVideos->total()/$perPage)) disabled @endif">{{ trans('site.End') }}</a>
                                    </li>
