			...
			<div class="panel panel-default clearfix">
				<div class="clearfix">
					<div class="col-md-9 no-padding">
						<h4 class="live-warning">
							{{ trans('site.LiveWarning') }} - <a href="https://get.adobe.com/ru/flashplayer/" target="_blank">Adobe Flash Player</a>
						</h4>
						<div id="player"></div> 
					...
					<div class="col-md-3 no-padding">
						<ul class="playlist">
							@foreach($streams as $key=> $stream)
							<li class="stream">
								<a href="javascript:playStream('{{ $stream->getStreamUrl()}}', '../{{ $stream->getFileBig()}}', {{$stream}})" onClick="return dataContent({{$key+99}})" >
