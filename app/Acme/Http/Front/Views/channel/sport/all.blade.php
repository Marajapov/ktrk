                     ...
                     <div class="clearfix videos-padding">
                        ...
                        <div class="col-sm-12 margin-with-bottom">
                          <nav>
                             <ul class="pagination">
                                <li>
                                   <a href="{{ route('sport.videos.all', ['page' => 1]) }}" class="btn btn-default @if($allVideos->currentPage() == 1) disabled @endif">{{ trans('site.Start') }}</a>
                                </li>
                                <li>
                                ...
                                <li class="@if(($j > $allVideos->currentPage()+3) || ($j < $allVideos->currentPage()-3)) hidden @endif">
                                   <a href="{{ route('sport.videos.all', ['page' => $j]) }}" class="btn btn-default @if($allVideos->currentPage() == $j) active @endif">
                                   {{ $j++ }}
                                   </a>
                                </li>
                                @endfor
                                ...
                                <li>
                                   <a href="{{ route('sport.videos.all', ['page' => ceil($allVideos->total()/$perPage)]) }}" class="btn btn-default @if($allVideos->currentPage() == ceil($allVideos->total()/$perPage)) disabled @endif">{{ trans('site.End') }}</a>
                                </li>
                             </ul>
                          </nav>
                        </div>                        
