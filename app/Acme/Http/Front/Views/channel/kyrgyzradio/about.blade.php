   ...
   <section id="about">
         ...
         <div class="row">
            ...
            <h3 class="column-title text-center">Тарыхы</h3>
               ...
               <p>Улуттук  адабият менен искусствонун татыктуу өкүлдөрүн угармандарга таанытуу. (“Бейне”, “Түз эфирдеги жолугушуу”, “Жарыгы калган жылдыздар”, “Инсан”, ж.б.).</p>
               <p>Кыргыз адабиятындагы мыкты чыгармалардын радио-  вариантын иштеп чыгып (көркөм окуулар, спектаклдер, постановкалар ж.б.), угармандардын көркөм табитин калыптоо.</p>
               <p>Ата-бабалардан калган көркөм  мурастарыбызды, кол өнөрчүлүгүбүздү  угармандарга жайылтуу. (“Кыргыз радиосунун алтын казынасынан”,  “Мен кыргызмын”, ”Мурас”, “Көөнө тарых”, “Өнөркана” ж.б.).</p>
               <p>Маданият тармагындагы күнүмдүк иш-чаралар, жаңылыктар менен угармандарды тааныштыруу. (“Кутман таңың менен, Кыргы стан”,  “Маданий жаңылыктар”, “Муз-обо” ж.б.).</p>
               <p>Таанытып-билдирүүчү, тарбия берүүчү багыттагы уктуруулар.</p>
               <p>“Асыл ойлор”, “Мен билген улут каадасы”, “Адеп”, “Унутта калган уютку”, “Адистин пикири” ж.б.). </p>
            </div>
