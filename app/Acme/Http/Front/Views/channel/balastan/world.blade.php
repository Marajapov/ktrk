                    ...
                    <div class="col-md-12 aboutshow">
                        <div class="media">
                            ...
                            <div class="media-body media-middle">
                                ...
                                <p>Бүгүнкү күндө балдар көбүнчө ар кандай анимациялык фильмдерге, компюьтердик оюндарга , интернетке кызыгышат. Мунун кесепетинен алар китеп окуудан алыстап калганы байкалат. Улуу ойчул Белинский  “Адамдар китеп окуну таштаса, алар ой ойлонуудан да калат” – деп айтканы бар.  Демек китепке кызыкпаган, китеп окубаган балдар жетиштүү билимге ээ боло албайт.  Бирок ар бир эле ата-эне өз баласын тартиптүү, билимдүү болуп чоңоюшун каалайт. Муну ишке ашыруунун эң жөнөкөй жолу үйбүлөбүз менен бирге күн сайын китеп окуу. 
                                </p>
                                <p>Ошондуктан Коомдук биринчи канал, Кыргызстандагы Ага Хан фондунун демилгеси менен үйбүлөлүк “Биргеокуйбуз” шоу программасын жалпы көрөрмандарга сунуштайт.
                                </p>
                                <p>Көрсөтүүнүн көлөмү: 40 мүнөт</p>
                                <p>Алып баруучу: Нурсултан Майназаров</p>
                                <p>Сценарийин жазгандар: Айдай Зарылова, Мээрим Керимкул кызы</p>
                                <p class="link">
                ...
                @elseif(app()->getlocale() == 'kg')
                    <div class="col-md-12 aboutshow">
                        <div class="media">
                            ...
                            <div class="media-body media-middle">
                                <h4 class="media-heading">Таалимтай</h4>
                                <p>“Келечек” студиясы жана ” Баластан” каналы аркылуу “Таалимтай” көрсөтүүсү эфирге чыгып жатат. Балдарга арналган булл телекөрсөтүү жуманын ишемби, жекшемби күндөрү эфиргечыгат. Көрсөтүүнүн негизги максаты: балдарга кыргыздын канына, кыргыз менталитетине ылайык келген таалим- тарбиялык мааниге ээ сюжеттер берилет. Алардынбардыгы юмор, күлкү менен коштолуп турат.
                                </p>
                                <p>2014- жылы телекөрүүчүлөрдү сурамжылоонун натыйжасында, “Таалимтай” көрсөтүүсү КТРК боюнча биринчи орунду ээлеп «Мыктыдолбоор» деген наамды жеңип алган. Жыл аягында Таалимтай көрсөтүүсү беш жашка чыгат.</p>
                ...
                @elseif(app()->getlocale() == 'kg')
                    <div class="col-md-12 aboutshow">
                        <div class="media">
                            ...
                            <div class="media-body media-middle">
                                <h4 class="media-heading">Күн балдары</h4>
                                <p>“Күн балдары”  - булар – бийге шыктуу,  таланттуу өспүрүмдөрдүн катышуусундагы концерттик программа.</p>
                                <p>Программа ар жуманын ишемби жана жекшемби күндөрү Коомдук биринчи каналдын эфиринен көрсөтүлөт. Көлөмү  30 мүнөт.  Алып баруучулар:  Катаганова  Назик  жана  Советбеков  Байэл.</p>
                                <p class="link">
                                    <a href="{{ route('balastan.videos') }}">Видео категорияга өтүү</a>
                                </p>
                            </div>
                ...
                @elseif(app()->getlocale() == 'kg')
                    <div class="col-md-12 aboutshow">
                        <div class="media">
                            ...
                            <div class="media-body media-middle">
                                <h4 class="media-heading">Баарын билгим келет</h4>
                                <p>«Баарын билгим келет» көрсөтүүсүнүн максаты бала бакчадан баштап мектеп курака чейинки балдарды тура жолго үндөө, аң сезимин өстүрүү, пайдалуу жана кызыктуу маалыматтарды берүү,балдардын интеллектуалдык деңгээлин жогорулатуу,  дүйнөгө болгон көзкарашын туура калыптандыруу.</p>
                                ...
                                <p>«Сонун ыр» түрмөгүндө бала бакчадагы бал тилдүүбалдар ар кандай темада жаттаган ырларын көркөм айтып беришет. Ыр жаттоо балдардын эс тутумун  жакшыртып, туура сүйлөөгө үйрөтөт.</p>
