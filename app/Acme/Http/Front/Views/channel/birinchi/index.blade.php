               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     <ul class="nav navbar-nav onenavbar">
                        <li class="dropdown">
                           <a href="#" class="dropdown-toggle" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false">О радио <i class="fa fa-angle-down"></i></a>
                           <ul class="dropdown-menu">
                              <li><a href="{{ route('birinchi.about') }}">О телеканале</a></li>
      ...
      <div class="row specnews">
         ...
         <div class="col-md-12 col-sm-6 col-xs-12 specpad">
            <div class="featured_3">
               <div class="col-md-4 onepadding">
                  <div class="featured_element">
                     <div class="featured_item"> <img width="356" height="267" src="{{asset('images/gallery/001.jpg')}}" class="attachment-thr-fa-third wp-post-image" alt="36"></div>
                     ...
                     <div class="featured_title_over"  style="bottom: 0px;">
                        <h2><a href="#">Кыргыз бильярдчылар Орусияда күч сынашууда</a></h2>
                     </div>
                  </div>
               </div>
               <div class="col-md-4 onepadding">
                  <div class="featured_element">
                     <div class="featured_item"> <img width="356" height="267" src="{{asset('images/gallery/002.jpg')}}" class="attachment-thr-fa-third wp-post-image" alt="32"></div>
                     <div class="featured_date">
                        <p>2 Декарь, 2015</p>
                     </div>
                     <div class="featured_cat">
               ...
               <div class="col-md-4 onepadding">
                  <div class="featured_element">
                     <div class="featured_item"> <img width="356" height="267" src="{{asset('images/gallery/003.jpg')}}" class="attachment-thr-fa-third wp-post-image" alt="42"></div>
                     <div class="featured_date">
                        <p>2 Декарь, 2015</p>
                     </div>
                     <div class="featured_cat">
                     ...
                     <a href="#" class="f_overlay"></a>
                     <div class="featured_title_over" style="bottom: 0px;">
                        <h2><a href="#">Кечээ болгон жер титирөөдөн бир катар социалдык объекттер жабыркады</a></h2>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="featured_4 specpad" >
            <div class="col-md-3 onepadding">
               <div class="featured_element">
                  <div class="featured_item"> <img width="267" height="267" src="{{asset('images/gallery/004.jpg')}}" class="attachment-thr-fa-quarter wp-post-image" alt="39"></div>
                  <div class="featured_date">
                     <p>2 Декарь, 2015</p>
                  </div>
                  <div class="featured_cat">
            ...
            <div class="col-md-3 onepadding">
               <div class="featured_element">
                  <div class="featured_item"> <img width="267" height="267" src="{{asset('images/gallery/005.jpg')}}" class="attachment-thr-fa-quarter wp-post-image" alt="44"></div>
                  <div class="featured_date">
                     <p>2 Декарь, 2015</p>
                  </div>
                  <div class="featured_cat">
