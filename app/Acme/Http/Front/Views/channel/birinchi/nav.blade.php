      ...
      <div class="container">
         ...
         <div class="col-md-9 oneheader">
            ...
            <ul class="nav navbar-nav oneline">
               ...
               <li class="onetime"><a href="{{ asset('online/online-1radio.php')}}" onclick="window.open(this.href, '', 'scrollbars=1,height='+Math.min(200, screen.availHeight)+',width='+Math.min(300, screen.availWidth)); return false;"><button class="btn"><i class="fa fa-microphone blink"></i><span>{{ trans('radiopages.Live') }}</span></button></a></li>
            </ul>
