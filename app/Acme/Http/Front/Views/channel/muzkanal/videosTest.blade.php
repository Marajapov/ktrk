                                ...
                                @if($MediaNew)
                                    ...
                                    <div class="m-block all-block">
                                        ...
                                        <div class="m-extra all-extra clearfix">                                          
                                            @if($row->program)
                                                <a class="m-project all-project" href="#">
                            ...
                            <nav class="pagination-nav clearfix">
                                <ul class="pagination">
                                    <li class="pagination-auto">
                                        <a href="{{ route('muzkanal.videos.test', ['page' => 1]) }}" class="@if($MediaNew->currentPage() == 1) disabled @endif">{{ trans('site.Start') }}</a>
                                    </li>
                                    <li>
                                    ...
                                    @if($MediaNew->lastPage() > 4)
                                        @if($MediaNew->currentPage() < 3)
                                            @for($i = 1; $i <= 5; $i++)
                                                <li>
                                                    <a href="{{ route('muzkanal.videos.test', ['page' => $i]) }}" class="@if($MediaNew->currentPage() == $i) active @endif">
                                                        {{ $i }}
                                                    </a>
                                                </li>
                                            @endfor
                                    ...
                                    <li class="pagination-auto">
                                        <a href="{{ route('muzkanal.videos.test', ['page' => ceil($MediaNew->total()/$perPage)]) }}" class="@if($MediaNew->currentPage() == ceil($MediaNew->total()/$perPage)) disabled @endif">{{ trans('site.End') }}</a>
                                    </li>
