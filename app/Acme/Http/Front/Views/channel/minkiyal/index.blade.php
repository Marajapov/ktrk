...
<div id="main-slider">
    <div class="banners">
        @if($anons)
            @foreach($anons as $banners)
                <div>
                    <img src="{{asset($banners->thumbnail)}}" width="1366" height="500" alt="">
                    <div class="container">
                        <div class="banners-content">
                            {{--<h2><span>{{ $row->getNameOne() }}</span></h2>--}}
                        </div>
...
<div class="prim-container">
    <div class="container main_back">
        <div class="info">
            @if($anonstop)
                <div id="allposts">
                    @foreach($anonstop as $key=> $row2)
                        <div class="col-md-3 col-sm-12 postshow">
                            <a href="#" data-toggle="modal" data-target="#{{ $key+99 }}">
                                <img src="{{asset($row2->thumbnail)}}" class="img-responsive" alt="">
                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">{{$row2->name}}</h4>
                                    </div>
