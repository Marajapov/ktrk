            ...
            <div class="panel panel-default panel-top-news">
              ...
              <div class="panel-body">
                ...
                <!-- end generalPost6 -->
                        ...
                        <div class="panel panel-default panel-carousel peoplereporter hidden-xs">
                    ...
                    <div class="top-right-block col-md-4">
                        <div class="panel panel-default panel-promo">
                            ...
                            <div class="panel-body main-video">
                                ...
                                <div class="slider slider-nav hidden-xs">
                                    <div>
                        ...
                        <a href="#" class="text-center ads ads-300x250 middle-ad hidden-xs">
                  ...
                  @foreach($latestPosts as $post)
                    <li class="list-group-item news-item">
                      ...
                      <div class="news-adds clearfix">
                        ...
                        <a href="#" class="text-center ads hidden-xs">
