                    ...
                    <div class="panel-body second-panel-body">
                      ...
                      <div class="col-md-6 ns-team">
                        ...
                        <div class="ns-info">
                          ...
                          @if($lc == 'kg')
                            <p class="ns-desc">
                              Акын жана жазуучу. Бир нече жыйнактардын автору. “Советтик Кыргызстан” гезитинде, “Кыргызстан” жана “Адабият” басылмаларында иштеген.  Кыргызстан жазуучулар союзунун мурдагы жетекчиси.</p>
                            <p>Байкоочулар кеңешине президент тарабынан сунушталган. </p>
                          @else
                            <p class="ns-desc">
                      ...
                      <div class="col-md-6 ns-team">
                        ...
                        <div class="ns-info">
                          ...
                          @if($lc == 'kg')
                            ...
                            <p>Байкоочулар кеңешине Жогорку Кеңеш тарабынан сунушталган.</p>
                          @else
                            <p class="ns-desc">
                            ...
                            <p>
                              В наблюдательный совет КТРК была предложена от Жогорку Кенеша.
                            </p>
                          @endif
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ns-team">
                        ...
                        <div class="ns-info">
                          ...
                          @if($lc == 'kg')
                            ...
                            <p>Байкоочулар кеңешине жарандык коом тарабынан сунушталган.</p>
                          @else
                            <p class="ns-desc">
                            ...
                            <p>
                              В наблюдательный совет КТРК был предложен от гражданского общества.
                            </p>
                          @endif
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ns-team">
                        ...
                        <div class="ns-info">
                          ...
                          @else
                            ...
                            <p>
                              В Наблюдательный совет КТРК была предложена от Президента.
                            </p>
                          @endif
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ns-team">
                        ...
                        <div class="ns-info">
                          ...
                          @if($lc == 'kg')
                            ...
                            <p>
                              Байкоочулар кеңешине жарандык коом тарабынан сунушталган.
                            </p>
                          @else
                            <p class="ns-desc">
                            ...
                            <p>
                              В Наблюдательный совет был предложен от гражданского общества.
                            </p>
                          @endif
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ns-team">
                        ...
                        <div class="ns-info">
                          ...
                          @else
                            ...
                            <p>
                              В Наблюдательный совет была предложена от гражданского общества.
                            </p>
                          @endif
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ns-team">
                        ...
                        <div class="ns-info">
                          <span class="ns-name"><strong>Халилов Ибрагим </strong></span>
                          @if($lc == 'kg')
                            <p class="ns-desc">
