                                ...
                                <nav class="pagination-nav">
                                    <ul class="pagination">
                                        <li class="pagination-auto">
                                            <a href="{{ route('front.general.filterDate', ['page' => 1]) }}" class="@if($posts->currentPage() == 1) disabled @endif">{{ trans('site.Start') }}</a>
                                        </li>
                                        <li>
                                        ...
                                        @for($i = 0, $j = 1; $i < $posts->total(); $i+=$perPage)
                                            <li class="@if(($j > $posts->currentPage()+3) || ($j < $posts->currentPage()-3)) hidden @endif">
                                                <a href="{{ route('front.general.filterDate', ['page' => $j]) }}" class="@if($posts->currentPage() == $j) active @endif">
                                                    {{ $j++ }}
                                                </a>
                                            </li>
                                        @endfor
                                        ...
                                        <li class="pagination-auto">
                                            <a href="{{ route('front.general.filterDate', ['page' => ceil($posts->total()/$perPage)]) }}" class="@if($posts->currentPage() == ceil($posts->total()/$perPage)) disabled @endif">{{ trans('site.End') }}</a>
                                        </li>
