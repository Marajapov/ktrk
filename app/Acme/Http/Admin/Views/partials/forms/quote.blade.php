...
<div class="panel panel-success">
    <div class="panel-body">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">{{ trans('site.AdminQuoteAuthor') }}</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">{{ trans('site.AdminQuoteAuthorRU') }}</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">{{ trans('site.AdminQuoteDesc') }}</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">{{ trans('site.AdminQuoteDescRU') }}</label>
            <div class="col-sm-10">
...
<a href="{{ route('admin.quote.index') }}" class="btn btn-default">{{ trans('site.Back') }}</a>