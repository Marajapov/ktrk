...
<div class="panel panel-success">
   <div class="panel-body">
      <div class="form-group">
         <label class="col-sm-2 control-label">Аталышы</label>
         <div class="col-sm-5">
      ...
      <div class="form-group">
         <label class="col-sm-2 control-label">Түшүндүрмө</label>
         <div class="col-sm-4">
            {!! Form::text('shortdesc', null, ["class" => "form-control"]) !!}
         </div>
         <label class="col-sm-2 control-label">Описание</label>
         <div class="col-sm-4">
            {!! Form::text('shortdescRu', null, ["class" => "form-control"]) !!}
         </div>
      </div>
      <div class="form-group">
         <label class="col-sm-2 control-label">Адис</label>
         <div class="col-sm-4">
            {!! Form::text('worktime', null, ["class" => "form-control"]) !!}
         </div>
         <label class="col-sm-2 control-label">Специальность RU</label>
         <div class="col-sm-4">
            {!! Form::text('worktimeRu', null, ["class" => "form-control"]) !!}
         </div>
      </div>
      <div class="form-group">
         <label class="col-sm-2 control-label">Локация</label>
         <div class="col-sm-4">
            {!! Form::text('location', null, ["class" => "form-control"]) !!}
         </div>
         <label class="col-sm-2 control-label">Локация RU</label>
         <div class="col-sm-4">
            {!! Form::text('locationRu', null, ["class" => "form-control"]) !!}
         </div>
      </div>
      <div class="form-group">
      ...
      <div class="col-sm-2 col-sm-offset-2">
         <div class="form-group">
            ...
            {!! Form::checkbox('published', 1, null, ["class" => "checkbox", "style" => "width: 34px; margin: 0"]) !!}
         </div>
      </div>
   </div>
</div>
...
<a href="{{ route('admin.vacancy.index') }}" class="btn btn-default">{{ trans('site.Back') }}</a>