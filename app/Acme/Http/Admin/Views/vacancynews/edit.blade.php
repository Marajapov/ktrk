...
<div class="row modals">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h4>Жаңылыкты өзгөртүү</h4>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				{!! Form::model($vacancynews, ['route' => ['admin.vacancynews.update', $vacancynews], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class'=>'form-horizontal']) !!}
				@include('Admin::partials.forms.vacancynews', $vacancynews)
				{!! Form::close() !!}
			</div>
		</div>
	</div>
