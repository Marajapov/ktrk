...
<div class="row modals">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h4>Стримди өзгөртүү</h4>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				{!! Form::model($stream, ['route' => ['admin.stream.update', $stream], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class'=>'form-horizontal']) !!}
				@include('Admin::partials.forms.stream', $stream)
				{!! Form::close() !!}
			</div>
		</div>
	</div>
